...
<html lang="en">
  ...
  <body>
    ...
    <?php if ($hero): ?>
      ...
      <!-- Delete Button -->
      <form action="hero_admin.php" method="POST">
      ...
      <!-- <form action= "edit_hero.php?id=<?php echo $hero['id'] ?>" method="POST"> -->
      <form action= "edit_hero.php?>" method="POST">
        <input type="hidden" name="id_to_edit" value="<?php echo $hero['id'] ?>">

        <div class="mb-3 d-flex justify-content-center">
          <a class="btn btn-outline-dark"  href="edit_hero.php?id=<?php echo $hero['id']; ?>">Edit</a>
          <!-- <button type="submit" method="POST" name="edit" href = "edit_hero.php?id=<?php echo $hero['id'] ?>"  value="edit" class="btn">Edit</button> -->
        </div>
        <!-- <input type="submit" name="delete" value="delete" class="btn"> -->
      </form>
